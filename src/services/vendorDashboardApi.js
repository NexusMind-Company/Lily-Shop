 ...
 * Base URL: https://lily-shop-backend.onrender.com
...
export const fetchSubscriberGrowth = async (period = "weekly") => {
  const response = await api.get("/vendor/dashboard/subscriber-growth/", {
    params: { period },
  });
  return response.data;
};
...
export const fetchRecentActivity = async () => {
  const response = await api.get("/vendor/dashboard/recent-activity/");
  return response.data;
};
...
export const fetchDailyPrepList = async (date = null) => {
  ...
  const response = await api.get("/vendor/orders/daily-prep-list/", { params });
  return response.data;
};
...
export const fetchVendorSubscriptions = async (params = {}) => {
  const response = await api.get("/vendor/subscriptions/", { params });
  return response.data;
};
...
export const fetchSubscriptionRequests = async () => {
  const response = await api.get("/vendor/subscriptions/requests/");
  return response.data;
};
...
export const acceptSubscriptionRequest = async (requestId) => {
  const response = await api.post(
    `/vendor/subscriptions/requests/${requestId}/accept/`
  );
  return response.data;
};
...
export const declineSubscriptionRequest = async (requestId, reason = "") => {
  const response = await api.post(
    `/vendor/subscriptions/requests/${requestId}/decline/`,
    { reason }
  );
  return response.data;
};
...
export const enableMonthlyPlan = async (planData) => {
  const response = await api.post("/vendor/plans/monthly/enable/", planData);
  return response.data;
};
...
export const updateMonthlyPlan = async (planId, planData) => {
  const response = await api.patch(`/vendor/plans/monthly/${planId}/`, planData);
  return response.data;
};
...
export const updateMeal = async (mealId, mealData) => {
  ...
  const response = await api.patch(`/vendor/menu/${mealId}/`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
  return response.data;
};
...
export const deleteMealItem = async (mealId) => {
  const response = await api.delete(`/vendor/menu/${mealId}/`);
  return response.data;
};
...
export const updateAvailability = async (availabilityData) => {
  const response = await api.put("/vendor/availability/", availabilityData);
  return response.data;
};
...
export const fetchCutoffSettings = async () => {
  const response = await api.get("/vendor/cutoff-settings/");
  return response.data;
};
...
export const updateCutoffSettings = async (settingsData) => {
  const response = await api.put("/vendor/cutoff-settings/", settingsData);
  return response.data;
};
...
export const fetchShopStatus = async () => {
  const response = await api.get("/vendor/shop-status/");
  return response.data;
};
...
export const pauseShop = async (pauseData) => {
  const response = await api.post("/vendor/shop-status/pause/", pauseData);
  return response.data;
};
...
export const resumeShop = async () => {
  const response = await api.post("/vendor/shop-status/resume/");
  return response.data;
};
...
export const fetchEarningsHistory = async (params = {}) => {
  const response = await api.get("/vendor/earnings/history/", { params });
  return response.data;
};
...
export const fetchEarningsChart = async (period = "weekly") => {
  const response = await api.get("/vendor/earnings/chart/", {
    params: { period },
  });
  return response.data;
};
...
export const fetchAddons = async () => {
  const response = await api.get("/vendor/addons/");
  return response.data;
};
...
export const createAddon = async (addonData) => {
  ...
  const response = await api.post("/vendor/addons/", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
  return response.data;
};
...
export const updateAddon = async (addonId, addonData) => {
  const response = await api.patch(`/vendor/addons/${addonId}/`, addonData);
  return response.data;
};
...
export const deleteAddon = async (addonId) => {
  const response = await api.delete(`/vendor/addons/${addonId}/`);
  return response.data;
};
...
export const fetchVendorConversations = async () => {
  const response = await api.get("/vendor/conversations/");
  return response.data;
};
...
export const fetchConversationMessages = async (conversationId, params = {}) => {
  const response = await api.get(
    `/vendor/conversations/${conversationId}/messages/`,
    { params }
  );
  return response.data;
};
...
export const sendBroadcastMessage = async (broadcastData) => {
  const response = await api.post("/vendor/broadcast/", broadcastData);
  return response.data;
};
...
export const fetchBroadcastHistory = async () => {
  const response = await api.get("/vendor/broadcast/history/");
  return response.data;
};
...
export const fetchMealRatings = async (params = {}) => {
  const response = await api.get("/vendor/ratings/", { params });
  return response.data;
};
...
export const fetchRatingsSummary = async () => {
  const response = await api.get("/vendor/ratings/summary/");
  return response.data;
};
...
export const fetchChurnedCustomers = async (params = {}) => {
  const response = await api.get("/vendor/churn/", { params });
  return response.data;
};
...
export const sendWinbackOffer = async (customerId, offerData) => {
  const response = await api.post(
    `/vendor/churn/${customerId}/offer-discount/`,
    offerData
  );
  return response.data;
};
