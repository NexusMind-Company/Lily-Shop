...
const Verification = () => {
  ...
  const [step1Completed] = useState(false);
  const [step2Completed] = useState(false);
  const [step3Completed] = useState(false);
        ...
        <div className="bg-white rounded-3xl p-6 ">
          ...
          <div className="space-y-4 mb-6">
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 bg-[#4caf50] rounded-md flex items-center justify-center shrink-0">
      ...
      <div className="max-w-lg mx-auto  p-6">
        ...
        <div className="bg-orange-100 border-l-4 border-orange-400 p-4 rounded-lg flex items-start gap-3">
          ...
          <p className="text-sm text-orange-800">
            Make sure you are in a place with enough light to take a clear
            photo.
          </p>
        </div>
        ...
        <div className="min-h-screen p-6">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-xs text-gray-600 text-center leading-relaxed">
              By subscribing to{" "}
              <span className="font-semibold">Lily Shop Verification</span>, you
              agree to a recurring payment of ₦10,000/month. This fee helps
              maintain verification, visibility benefits, and badge status. You
              can cancel anytime from your account settings. Canceling will
              remove your verified status and associated benefits.
            </p>
          </div>
        </div>
      </div>
      <div className=" p-6">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Government Issued ID (e.g., passport, national ID, or driver's
            Lincense
          </p>
          ...
          <div className="bg-white rounded-lg p-4 mb-6 text-sm">
            <ol className="space-y-2 list-decimal list-inside">
              <li>
                Make sure your ID card is clear enough and no parts are cut off
              </li>
              <li>
                Ensure it is a Government Issued ID, failure to do so will
                result in an automatic denial of your verification request.
              </li>
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-6">
        <div className="max-w-sm w-full bg-white p-8 text-center">
          ...
          <p className="text-gray-600 text-sm mb-8">
            ...
            <span className="font-semibold">₦10,000</span> to{" "}
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
            ...
            <span>
              Secured by{" "}
              <span className=" text-black font-bold ">paystack</span>
            </span>
          </div>
        </div>
      </div>
