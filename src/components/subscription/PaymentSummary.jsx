...
const PaymentSummary = ({ subtotal, deliveryFee, total }) => {
  return (
    <div className="mt-4 pt-6 border-t border-gray-200 dark:border-gray-800">
      <h3 className="text-text-main dark:text-white font-bold text-lg mb-4">
        Payment Summary
      </h3>
      <div className="bg-[#ffffff] dark:bg-surface-dark rounded-xl p-4 flex flex-col gap-3 shadow-sm">
        <div className="flex justify-between items-center text-sm">
          <span className="text-text-muted">
            Subtotal ({subtotal / 2700} meals)
          </span>
