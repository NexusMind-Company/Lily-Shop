...
const CustomerSubscriptionHeader = ({ onBack }) => {
  return (
    <header className="sticky top-0 z-sticky bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-sm border-b border-gray-100 dark:border-white/5 transition-colors duration-300">
