...
/**
 * SubscriptionOverviewHeader component for the subscription overview page
 ...
 */
const SubscriptionOverviewHeader = ({ onBack, onFilter }) => {
  return (
...
SubscriptionOverviewHeader.propTypes = {
