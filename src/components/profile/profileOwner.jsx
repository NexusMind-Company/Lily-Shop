...
const posts = Array(9).fill({ views: "2.1k", img: "/dress.png" });
const announcements = Array(9).fill({
  views: "2.1k",
  title: "New Collection!",
  img: "/announcement.png",
});
const favorites = Array(9).fill({ views: "2.1k", name: "Favorite Dress", img: "/favorite.png" });
    ...
    <div className="grid grid-cols-3 gap-3 my-2 px-4 ">
      {posts.map((post, i) => (
        <div key={i} className="relative rounded-lg">
          <img src={post.img} alt="Post" className="w-full aspect-square object-cover bg-black" />
  ...
  return (
    <div className="grid grid-cols-3 gap-3 my-2 px-4">
      {announcements.map((item, i) => (
        <div key={i} className="relative rounded-lg">
          <img src={item.img} alt="Post" className="w-full aspect-square object-cover bg-black" />
          <div className="absolute bottom-1 left-1 flex items-center text-white text-xs">
  ...
  return (
    <div className="bg-white min-h-screen text-gray-800">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <Link to=""><LinkIcon size={25} /></Link>
        <Link to="/settings"><Settings size={25}/></Link>
      </div>
      </div>
      ...
      <div className="mt-6 px-4">
        ...
        <p className="mt-1 text-sm">
          Bloom Threads offers expertly crafted clothing for every occasion. We focus on quality and
          unique designs that allow your personal style to bloom.
        </p>
