    ...
    <div className="flex md:hidden justify-around items-center bg-white h-15 pt-2 pb-[max(env(safe-area-inset-bottom),8px)] shadow-inner fixed bottom-0 left-0 w-full z-50">
      ...
      >
        <div className="grid place-items-center size-10 absolute -top-3 transform -translate-x-1/2 left-1/2">
          {activePage === "home" ? (
            <img src="/icons/home-active.svg" className="h-7 w-7" alt="Home" />
          ) : (
            <img src="/icons/home-4.svg" className="h-7 w-7" alt="Home" />
          )}
        </div>
      ...
      >
        <div className="grid place-items-center size-10 absolute -top-3 transform -translate-x-1/2 left-1/2">
          {activePage === "create" ? (
            <img src="/icons/create-circle.svg" className="text-lily h-7 w-7" alt="Create" />
          ) : (
            <img src="/icons/create-circle.svg" className="h-7 w-7" alt="Create" />
          )}
        </div>
      ...
      >
        <div className="grid place-items-center size-10 absolute -top-3 transform -translate-x-1/2 left-1/2">
          {activePage === "inbox" ? (
            ...
            <div className="relative">
              <img src="/icons/message-3.svg" className="h-7 w-7" alt="Inbox" />
              <div className="absolute bg-red-500 rounded-full h-2 w-2 top-0 right-0"></div>
            </div>
          )}
        </div>
      ...
      >
        <div className="grid place-items-center size-10 absolute -top-3 transform -translate-x-1/2 left-1/2">
          {activePage === "profile" ? (
            <img src="/icons/user-active.svg" className="text-lily h-7 w-7" alt="Profile" />
          ) : (
            <img src="/icons/user.svg" className="h-7 w-7" alt="Profile" />
          )}
        </div>
