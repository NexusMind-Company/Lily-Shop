...
import { X, Copy, Share2, Link as LinkIcon, MessageCircle, Send } from "lucide-react";
            ...
            <div className="p-5">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-800">More options...</span>
                </button>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 p-3 rounded-2xl hover:bg-gray-50 transition-colors cursor-pointer"
                >
                  <div className={`w-11 h-11 rounded-full flex items-center justify-center ${isCopied ? "bg-lily" : "bg-gray-100"}`}>
                    {isCopied ? (
                  ...
                  <span className={`text-sm font-medium ${isCopied ? "text-lily" : "text-gray-800"}`}>
