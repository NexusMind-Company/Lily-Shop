...
import { ChevronLeft, Crown, CheckCircle, Shield, MessageCircle, CreditCard, Wallet } from "lucide-react";
import { initiateUserSubscriptionPayment, getUserSubscriptionStatus } from "../redux/userSubscriptionSlice";
...
const UserSubscriptionPage = () => {
  ...
  const handleSubscribe = async () => {
    try {
      ...
      const result = await dispatch(initiateUserSubscriptionPayment(paymentData)).unwrap();
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white shadow-sm">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center space-x-4">
            ...
            <h1 className="text-xl font-bold text-gray-800">Premium Subscription</h1>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6">
          ...
          <div className="bg-gradient-to-br from-pink-500 to-pink-600 rounded-2xl p-6 text-white text-center">
            ...
            <p className="text-pink-100">Connect directly with vendors and get personalized quotes</p>
          </div>

          {/* Benefits */}
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">What you get:</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <CheckCircle className="text-green-500 mt-0.5 flex-shrink-0" size={20} />
                <div>
                  <p className="font-medium text-gray-800">Direct Messaging</p>
                  <p className="text-sm text-gray-600">Send messages directly to vendors</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="text-green-500 mt-0.5 flex-shrink-0" size={20} />
                <div>
                  ...
                  <p className="text-sm text-gray-600">Request custom quotes for your needs</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="text-green-500 mt-0.5 flex-shrink-0" size={20} />
                <div>
                  <p className="font-medium text-gray-800">Priority Responses</p>
                  <p className="text-sm text-gray-600">Get faster responses from vendors</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Only serious buyers can contact vendors</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <label className={`flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all ${
                selectedPaymentMethod === 'paystack' ? 'border-pink-600 bg-pink-50' : 'border-gray-200'
              }`}>
                <input
                  type="radio"
                  name="payment"
                ...
                <div className="flex-1">
                  <div className="font-medium text-gray-800">Card / Bank Transfer</div>
                  <div className="text-sm text-gray-600">Paystack secure payment</div>
                </div>
              ...
              {/* Wallet */}
              <label className={`flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all ${
                selectedPaymentMethod === 'wallet' ? 'border-pink-600 bg-pink-50' : 'border-gray-200'
              }`}>
                <input
                  type="radio"
                  name="payment"
                ...
                <div className="flex-1">
                  <div className="font-medium text-gray-800">Wallet Balance</div>
