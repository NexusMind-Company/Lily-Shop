  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 bg-[#25D366] text-white p-4 rounded-full shadow-xl hover:scale-105 transition-transform z-50 flex items-center justify-center"
      >
